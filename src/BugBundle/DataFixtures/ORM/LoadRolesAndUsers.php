...
class LoadRolesAndUsers implements FixtureInterface, ContainerAwareInterface
{
    ...
    private $names = array('Noah', 'Emma', 'Ethan', 'Oliver', 'Evelyn', 'Evelyn', 'Madison', 'Emily', 'Hannah', 'Zoe', 'Mason', 'Elizabeth', 'Jack',
        'Ella', 'Jacob', 'Madison', 'Oliver', 'Avery', 'Jackson', 'Charlotte', 'Logan', 'Alexander', 'Addison', 'Aria', 'Natalie');
    private $lastName = array('Moore', 'Anderson', 'Taylor', 'Thomas', 'White', 'Harris', 'Garcia', 'Robinson', 'Lee', 'Hall', 'Allen', 'Martin', 'Rodriguez',
        'Lewis', 'Clark', 'Martinez', 'Walker');
    private $inent;
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $persist([IssueStatus::OPEN,IssueStatus::REOPEN, 'Needs Work', 'Needs Review', 'Done', 'Patch', 'Fixed', 'Postponed', 'Closed'], 'IssueStatus');
